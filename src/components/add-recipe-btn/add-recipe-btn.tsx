...
import styles from './add-recipe-btn.module.css';

export const AddRecipeBtn = () => {
    //! обёртка над кнопкой - не лишняя. Без неё неадекватно работает z-index
    return (
        <div className={styles.wrapper}>
            <div>
                <button className={styles.btn}>
                    ...
                    >
                        <path
                            d='M23.2531 2.9101C23.3932 3.05069 23.4719 3.2411 23.4719 3.4396C23.4719 3.63811 23.3932 3.82852 23.2531 3.9691L21.6886 5.5351L18.6886 2.5351L20.2531 0.969102C20.3937 0.828498 20.5844 0.749512 20.7833 0.749512C20.9822 0.749512 21.1729 0.828498 21.3136 0.969102L23.2531 2.9086V2.9101ZM20.6281 6.5941L17.6281 3.5941L7.40856 13.8151C7.32601 13.8976 7.26386 13.9983 7.22706 14.1091L6.01956 17.7301C5.99766 17.7961 5.99455 17.8669 6.01058 17.9346C6.02661 18.0023 6.06114 18.0642 6.11032 18.1133C6.1595 18.1625 6.22139 18.1971 6.28907 18.2131C6.35675 18.2291 6.42755 18.226 6.49356 18.2041L10.1146 16.9966C10.2252 16.9602 10.3259 16.8986 10.4086 16.8166L20.6281 6.5956V6.5941Z'
                            fill='#FFFFD3'
                        />
                        <path
                            fillRule='evenodd'
